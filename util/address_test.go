...
func TestAddresses(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "mainnet p2pk",
			addr:    "karlsen:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35c8mx62u3l",
			encoded: "karlsen:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35c8mx62u3l",
			valid:   true,
		...
		{
			name:    "mainnet p2pk 2",
			addr:    "karlsen:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cx7flvuzv",
			encoded: "karlsen:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cx7flvuzv",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixKaspa,
				[util.PublicKeySize]byte{
		...
		{
			name:    "testnet p2pk",
			addr:    "karlsentest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35cwtnp95ze",
			encoded: "karlsentest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35cwtnp95ze",
			valid:   true,
			result: util.TstAddressPubKey(
		...
		// ECDSA P2PK tests.
		{
			...
			addr:    "karlsen:q835ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35e2s5j8xs98r",
			encoded: "karlsen:q835ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35e2s5j8xs98r",
			valid:   true,
		...
		},
		{
			...
			addr:           "karlsen:qr35ennsep3hxfe7lnz5ee7j5jgmkjswss74as46gx",
			valid:          false,
			passedPrefix:   util.Bech32PrefixKaspa,
			expectedPrefix: util.Bech32PrefixKaspa,
		},
		...
		{
			name:    "mainnet p2sh",
			addr:    "karlsen:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdz3qw5ugf7",
			encoded: "karlsen:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdz3qw5ugf7",
			valid:   true,
		...
		{
			name:    "mainnet p2sh 2",
			addr:    "karlsen:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxwq98nmep",
			encoded: "karlsen:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxwq98nmep",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixKaspa,
				[blake2b.Size256]byte{
		...
		{
			name:    "testnet p2sh",
			addr:    "karlsentest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vxfltt45j7",
			encoded: "karlsentest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vxfltt45j7",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixKaspaTest,
				[blake2b.Size256]byte{
...
func TestDecodeAddressErrorConditions(t *testing.T) {
	tests := []struct {
		...
		{
			"karlsensim:raskzctpv9skzctpv9skzctpv9skzctpvy37ct7zafpv9skzctpvyqfusatdg",
			util.Bech32PrefixKaspaSim,
			"unknown address type",
		},
		{
			"karlsensim:raskzcg62uftfgk",
			util.Bech32PrefixKaspaSim,
			"unknown address type",
		},
		{
			"karlsentest:qqq65mvpxcmajeq44n2n8vfn6u9f8l4zsyllsa7fye",
			util.Bech32PrefixKaspa,
...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"karlsen", util.Bech32PrefixKaspa, false},
		{"karlsentest", util.Bech32PrefixKaspaTest, false},
		{"karlsensim", util.Bech32PrefixKaspaSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixKaspa, "karlsen"},
		{util.Bech32PrefixKaspaTest, "karlsentest"},
		{util.Bech32PrefixKaspaSim, "karlsensim"},
		{util.Bech32PrefixUnknown, ""},
	}
