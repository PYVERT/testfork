...
// installService attempts to install the karlsend service. Typically this should
...
// removeService attempts to uninstall the karlsend service. Typically this should
...
// startService attempts to Start the karlsend service.
