...
const (
	defaultConfigFilename      = "karlsend.conf"
	defaultLogLevel            = "info"
	defaultLogDirname          = "logs"
	defaultLogFilename         = "karlsend.log"
	defaultErrLogFilename      = "karlsend_err.log"
	...
	sampleConfigFilename    = "sample-karlsend.conf"
...
var (
	...
	DefaultAppDir = util.AppDir("karlsend", false)
...
// Flags defines the configuration options for karlsend.
//
...
type Flags struct {
	...
	Listeners                       []string      `long:"listen" description:"Add an interface/port to listen for connections (default all interfaces port: 42111, testnet: 42211)"`
	...
	RPCListeners                    []string      `long:"rpclisten" description:"Add an interface/port to listen for RPC connections (default port: 42110, testnet: 42210)"`
...
// Config defines the configuration options for karlsend.
//
// See loadConfig for details on the configuration load process.
type Config struct {
	*Flags
...
// DefaultConfig returns the default karlsend configuration
...
//
// The above results in karlsend functioning properly without any config settings
...
// createDefaultConfig copies the file sample-karlsend.conf to the given destination path,
